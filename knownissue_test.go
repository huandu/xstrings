...
// promises, but the implementation does not provide it today, therefore all
// of them are skipped so that `go test ./...` keeps passing until a fix is
// decided.
//
// Remove the t.Skip call from a test once its issue is fixed.

// Successor: the carry generated by '9' must be '1' instead of '0'.
//
// current: Successor("9") == "00", Successor("99") == "000", Successor("9z") == "00a"
// want:    "10", "100", "10a" (Ruby: "9".succ == "10", "99".succ == "100")
func TestIssueSuccessorCarryFromNine(t *testing.T) {
	t.Skip(`known bug: Successor emits '0' as the carry of '9', e.g. Successor("9") == "00", want "10"`)
